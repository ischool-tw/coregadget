                    ...
                    result: function (response, error, http) {
                        $scope.$apply(function () {
                            if (!response)
                                ...
                                //    }
                                //}
                                //if (response.PsychologicalTestsRecord && response.PsychologicalTestsRecord.InterestTest18) {
                                //    //新增 興趣測驗
                                //    stuRec.PsychologicalTestsRecord.InterestTest18 = response.PsychologicalTestsRecord.InterestTest18;

                                //    if (response.PsychologicalTestsRecord.InterestTest18.ImplementationDate) {
                                //        // 轉成 mm 微秒
                                //        var d = Date.parse(response.PsychologicalTestsRecord.InterestTest18.ImplementationDate);
                                //        var dd = new Date(d);

                                //        // 轉顯示成 YYYY/MM/d 的格式
                                //        stuRec.PsychologicalTestsRecord.InterestTest18.ImplementationDate = dd.getFullYear() + "/" + (dd.getMonth() + 1) + "/" + dd.getDate();
                                //    }
                                //}
                                //if (response.PsychologicalTestsRecord && response.PsychologicalTestsRecord.MajorinTest) {
                                //    //新增 興趣測驗
                                //    stuRec.PsychologicalTestsRecord.MajorinTest = response.PsychologicalTestsRecord.MajorinTest;

                                //    if (response.PsychologicalTestsRecord.MajorinTest.ImplementationDate) {
                                //        // 轉成 mm 微秒
                                //        var d = Date.parse(response.PsychologicalTestsRecord.MajorinTest.ImplementationDate);
                                //        var dd = new Date(d);

                                //        // 轉顯示成 YYYY/MM/d 的格式
                                //        stuRec.PsychologicalTestsRecord.MajorinTest.ImplementationDate = dd.getFullYear() + "/" + (dd.getMonth() + 1) + "/" + dd.getDate();
                                //    }
                                //}

                                if (response.PsychologicalTestsRecord) {
                                    stuRec.PsychologicalTestsRecord = [].concat(response.PsychologicalTestsRecord || []);
                                }
                                else {
                                    stuRec.PsychologicalTestsRecord = null;//'沒有心理測驗紀錄';
                                }
                            }
                        });
                    }
