...
(function() {
  var getAttendance, getDiscipline, getMorality, global, myHandleArray, resetAttendance, resetData, resetDiscipline, resetMorality, resetSchoolYearSeme, runFirstStudent, set_error_message;
  ...
  getMorality = function() {
    ...
    if (((_ref = global.morality) != null ? _ref.Response : void 0) != null) {
      ...
      gadget.getContract("ischool.AD.parent").send({
        ...
        result: function(response, error, xhr) {
          var btn_active, _association, _ref1;
          ...
          if (btn_active.attr("school-year") === global.behavior.schoolYear && btn_active.attr("semester") === global.behavior.semester) {
            resetMorality();
            if (error != null) {
              return set_error_message('#mainMsg', 'GetAssociation', error);
            } else {
              _association = {};
