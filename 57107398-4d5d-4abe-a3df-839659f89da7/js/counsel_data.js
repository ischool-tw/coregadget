_gg.col_Question = {
        ...
        'A4' :[
            ...
            { ID: 'A4', GroupName: '家庭狀況', Name: '兄弟姊妹_畢肆業學校', Alias: '畢業/就讀學校', TagName: 'SchoolName' },
        ...
        'B4' :[
            ...
            { ID: 'B4', GroupName: '自我認識', Name: '個性_4', Alias: '個性' },
            { ID: 'B4', GroupName: '自我認識', Name: '優點_4', Alias: '優點' },
            { ID: 'B4', GroupName: '自我認識', Name: '需要改進的地方_4', Alias: '需要改進', ControlType: 'textarea' },
            { ID: 'B4', GroupName: '自我認識', Name: '填寫日期_4', Alias: '填寫日期' },
            { ID: 'B4', GroupName: '自我認識', Name: '個性_5', Alias: '個性' },
            { ID: 'B4', GroupName: '自我認識', Name: '優點_5', Alias: '優點' },
            { ID: 'B4', GroupName: '自我認識', Name: '需要改進的地方_5', Alias: '需要改進', ControlType: 'textarea' },
            { ID: 'B4', GroupName: '自我認識', Name: '填寫日期_5', Alias: '填寫日期' },
            { ID: 'B4', GroupName: '自我認識', Name: '個性_6', Alias: '個性' },
            { ID: 'B4', GroupName: '自我認識', Name: '優點_6', Alias: '優點' },
            { ID: 'B4', GroupName: '自我認識', Name: '需要改進的地方_6', Alias: '需要改進', ControlType: 'textarea' },
            { ID: 'B4', GroupName: '自我認識', Name: '填寫日期_6', Alias: '填寫日期' }
        ],
        'B5' :[
            ...
            { ID: 'B5', GroupName: '生活感想', Name: '內容1_3', Alias: '一年來的感想', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容2_3', Alias: '今後努力的目標', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容3_3', Alias: '期望師長給幫助', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '填寫日期_3', Alias: '填寫日期' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容1_4', Alias: '一年來的感想', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容2_4', Alias: '今後努力的目標', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容3_4', Alias: '期望師長給幫助', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '填寫日期_4', Alias: '填寫日期' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容1_5', Alias: '一年來的感想', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容2_5', Alias: '今後努力的目標', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '內容3_5', Alias: '期望師長給幫助', ControlType: 'textarea' },
            { ID: 'B5', GroupName: '生活感想', Name: '填寫日期_5', Alias: '填寫日期' }
        ],
        'C1' :[
