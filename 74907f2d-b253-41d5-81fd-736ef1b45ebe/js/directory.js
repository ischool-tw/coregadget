            ...
            if (error !== null) {
                ...
                _gg.connection.send({
                    ...
                    result: function (response, error, http) {
                        ...
                        if (_gg.myself.ClassID) {
                            dropdown_txt += '<li><a href="#student1" data-toggle="tab" class="my-highLightItem" Kind="class" CID="' + (_gg.myself.ClassID || '') + '">' + (_gg.myself.ClassName || '') + ' 通訊錄</a></li>';
                        }
...
_gg.getMyInfo = function () {
    ...
    var photo;
    var photo_base64 = '';
    $('span[data-type=parentCode]').html('「' + (myself.ParentCode || '未設定') + '」');
    if (myself.Photo) {
    ...
    $('#edit-StudentName').val(myself.StudentName || '');
...
_gg.getStudentInfo = function() {
    ...
    var pdata = function() {
        ...
        _gg.connection.send({
            ...
            body: '<Request><Condition><StudentID>' + student.UserID + '</StudentID></Condition></Request>',
            result: function (response, error, http) {
                if (error !== null) {
        ...
        _gg.connection.send({
            ...
            result: function (response, error, http) {
                if (error !== null) {
                    ...
                    // 重設資料
                    myself.StudentName = studentname;
                    myself.Photo = photo;
