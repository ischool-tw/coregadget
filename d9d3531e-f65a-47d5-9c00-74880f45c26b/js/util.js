                    ...
                    if (error.dsaError.status === "504") {
                        switch (error.dsaError.message) {
                            ...
                            default:
                                ...
                                tmp_msg = tmp_msg.replace('TeacherId', '系統編號');
                                tmp_msg = tmp_msg.replace('TeacherName', '姓名');
                                tmp_msg = tmp_msg.replace('Nickname', '暱稱');
                                tmp_msg = tmp_msg.replace('Gender', '性別');
                                tmp_msg = tmp_msg.replace('LinkAccount', '帳號');
                                tmp_msg = tmp_msg.replace('TeacherCode', '代碼');
                        }
